  ...
  export const Logo = ({type = 'dark'}: LogoInterface) => {
    ...
    return (
      <div className="flex justify-center gap-[0.4rem]">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.7273 0.272461H10.1818V10.4543H7.63636V7.90882H2.54545V10.4543H0V15.5452H2.54545V18.0906H7.63636V15.5452H10.1818V18.0906H12.7273V15.5452H10.1818V10.4543H12.7273V0.272461ZM7.63636 15.5452H2.54545V10.4543H7.63636V15.5452Z" fill={color}/>
        <path d="M34.5227 25.727H31.9773V15.5452H34.5227V25.727Z" fill={color}/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M34.5227 10.4543V15.5452H37.0682V18.0906H42.1591V15.5452H44.7046V10.4543H42.1591V7.90882H37.0682V10.4543H34.5227ZM37.0682 10.4543H42.1591V15.5452H37.0682V10.4543Z" fill={color}/>
